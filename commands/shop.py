...
from modules.shop import SHOP, Item
...
async def shop(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    with db_session:
        ...
        if not (shop := SHOP.get(chatId=chat_id, threadId=thread_id)):
            shop = SHOP(chatId=chat_id, threadId=thread_id)
